 ...
 /**
    ...
    public function run()
    {
       ...
       Model::unguard();
         ...
         DB::table('users')->insert([
            'email' => 'DRantonio_magalhaes1@hotmail.com',
            'type' => 1,
