...
<div class="container">
  ...
  <h1 class="text-center">Show exercicio</h1>
           ...
           <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {!! Form::text('tipo', $exercicio->tipo, ['class'=> 'form-control', 'disabled' => true]) !!}
                </div>
            </div>
        </div>
        <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        {!! Form::text('intensidade',$exercicio->intensidade, ['class'=> 'form-control', 'disabled' => true]) !!}
                    </div>
                </div>
            </div>
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    {!! Form::text('calorias_gastas', $exercicio->calorias_gastas, ['class'=> 'form-control', 'disabled' => true]) !!}
                </div>
            </div>
        </div>
         <div class="row">
