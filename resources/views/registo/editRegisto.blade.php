...
<div class="container">
<h1 class="text-center">EditarRegisto Diario</h1>
  ...
  {!! Form::open(['route'=> ['registo.update', $registo->id], 'method' => 'PUT']) !!}
    <div class="col-md-8 col-md-offset-2">
        <div class="panel panel-default">
            <div class="panel-heading">Editar Registo Diario</div>
              ...
              <div class="row">
                  <div class="col-md-6">
                      <div class="form-group">
                          ...
                          {!! Form::text('glicose',$registo->glicose, ['class'=> 'form-control', 'onclick'=>'getValue()']) !!}
                      </div>
                  </div>
              </div>
